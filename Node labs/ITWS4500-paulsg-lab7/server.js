...
app.get('/visualize', (req, res) => { res.sendFile(__dirname + '/public/visualize.html'); });
...
app.get('/export/:type', (req, res) => { // type is a paramater passed in from angular
   ...
   res.status(200).send("Collection exported");
});

// start server
app.listen(port, () => console.log(`Paulsg - Lab 7 on port ${port}`));
